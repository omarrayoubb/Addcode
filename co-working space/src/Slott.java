...
public class Slott implements Serializable {
    ...
    */
    ...
    public static @NotNull ArrayList<Slott> CreateListOfSlots(int NumberOfReservations, double HourPrice){
    ...
    public static void DisplayListOfSlots(@NotNull ArrayList<Slott> slot){
